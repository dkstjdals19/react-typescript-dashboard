...
import { BotIcon, ChevronsLeft, ChevronsRight, Home, LayoutDashboard, LogOut, Store, Sun } from "lucide-react";
         ...
         >
            ...
            <nav className="flex flex-col">
                ...
                <Link to="/" className="flex items-center p-4">
                    ...
                    {isOpen ? (<span>프로젝트</span>) : null}
                </Link>
                <Link to="/chatgpt" className="flex items-center p-4">
                    <BotIcon className="w-5 h-5 mr-2"></BotIcon>
